...
class ApiClient(
    ...
    suspend fun getMultipleCharacter(characterRange: String): SimpleResponse<List<CharacterByIdResponse>> {
        return safeApiCall { rickAndMortyService.getMultipleCharacters(characterRange) }
    }
